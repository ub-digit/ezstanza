...
#
#     PHX_SERVER=true bin/ezstanza start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :ezstanza, EzstanzaWeb.Endpoint, server: true
end

if config_env() == :prod do

config :ezstanza, Ezstanza.DeploymentProvider.SSH,
  ssh_user_dir: System.get_env("DEPLOYMENT_SSH_USER_DIR"),
  ...
  #
  #     config :ezstanza, Ezstanza.Mailer,
